...
@Component({
  selector: 'app-calendario-psicologia',
  templateUrl: './calendario-psicologia.component.html',
  // styleUrls: ['./calendario-psicologia.component.css']
})
export class CalendarioPsicologiaComponent implements OnInit {
  ...
  public addOrUpdate(valid) {
    ...
    if (this.calendario.id != null && this.calendario.fechaInicio != null && this.calendario.descripcion != null) {
      ...
      if (this.calendario.fechaInicio != null && this.calendario.descripcion != null) {
        ...
        this.calendario.area = "PSICOLOGIA"
  ...
  public getAllCalendario() {
    ...
    this.httpCalendarioService.getAllCalendario().subscribe(recibe => {
      ...
      this.calendarios = this.getActivos("PSICOLOGIA");
